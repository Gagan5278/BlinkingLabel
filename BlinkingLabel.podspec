...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Gagan Vishal Mishra/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Gagan Vishal Mishra' => 'gagan.vishal@mmiholdings.co.za' }
  s.source           = { :git => 'https://github.com/Gagan Vishal Mishra/BlinkingLabel.git', :tag => s.version.to_s }
